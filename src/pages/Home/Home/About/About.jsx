            ...
            <div className="flex items-center -mx-3 sm:-mx-4">
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                <div className="py-3 sm:py-4">
                  <img
                    src="https://plus.unsplash.com/premium_photo-1663047910718-c8758a6785e9?q=80&w=1374"
                    alt=""
                    className="w-full md:h-[440px] rounded-2xl border-4 border-y-[#f86ca7]"
                  />
                </div>
                <div className="py-3 sm:py-4">
                  <img
                    src="https://img.freepik.com/premium-photo/doctor-is-making-check-up-cute-beautiful-cat_85574-12344.jpg?w=720"
                    alt=""
                    className="w-full md:h-[440px] rounded-2xl border-4 border-y-[#f86ca7]"
                  />
                </div>
              ...
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                <div className="relative z-10 my-4">
                  <img
                    src="https://img.freepik.com/premium-photo/close-up-smiling-young-female-veterinarian-carrying-dog-clinic_23-2147928527.jpg?w=720"
                    alt=""
                    className="w-full md:h-[440px] rounded-2xl border-4 border-y-[#f86ca7]"
                  />
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <button className="relative inline-block text-lg group">
                <span className="relative z-10 block px-12 py-4 overflow-hidden font-bold leading-tight text-white transition-colors duration-300 ease-out rounded-lg group-hover:text-white">
                  ...
                  <span className="absolute left-0 w-60 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-[#25373a] group-hover:-rotate-180 ease"></span>
